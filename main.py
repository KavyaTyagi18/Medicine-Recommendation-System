...
def get_predicted_value(patient_symptoms):
    ...
    for item in patient_symptoms:
        # Clean input: replace spaces with underscores to match dict keys
...
def helper(dis):
    ...
    # FIX: medications, diets, and workouts are often stored as strings that look like lists
    # We use ast.literal_eval to safely convert that string back into a real Python list
